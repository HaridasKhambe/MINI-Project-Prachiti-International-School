...
const Internet = () => {
  useEffect(() => {
    document.title = "Internet | JSPM College";
  }, []);
    ...
    <div>
      ...
      <div className='flex flex-col my-5 mx-4 md:mx-10 space-y-6'>
            <div className=' justify-center text-center'>  {/* title heading */}
                  <h1 className='text-4xl text-[var(--primary-color)] font-medium  pb-2 border-b-3 border-[var(--golden-border-b)] '>Internet</h1>
            </div>
           ...
           <div 
              ...
              >  {/*images */}
                  <div className=''>  {/* title heading */}
                        <h2 className='inline-flex text-2xl text-[var( --footer-bg)] font-medium  pb-2 border-b-2 border-[var(--golden-border-b)] '>Internet Spaces/Facilities</h2>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-4 lg:px-30'>
                  {facilitiesData.internet?.images?.length > 0 && facilitiesData.internet.images.map((item, index) => (
